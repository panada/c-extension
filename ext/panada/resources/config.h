...
ZEND_BEGIN_ARG_INFO_EX(arginfo_panada_resources_config_debug, 0, 0, 0)
	ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(panada_resources_config_method_entry) {
	PHP_ME(Panada_Resources_Config, _cache, arginfo_panada_resources_config__cache, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	PHP_ME(Panada_Resources_Config, debug, arginfo_panada_resources_config_debug, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	PHP_ME(Panada_Resources_Config, main, NULL, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	PHP_ME(Panada_Resources_Config, session, NULL, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	PHP_ME(Panada_Resources_Config, cache, NULL, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	PHP_ME(Panada_Resources_Config, database, NULL, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
